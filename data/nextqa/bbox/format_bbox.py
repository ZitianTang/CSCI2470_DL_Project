...
bbox_dir = '/oscar/data/superlab/datasets/vidor/features/bounding_boxes'

format_func = 'flexible_calc' # boxes, boxes_time
...
def parse_object_tracking_integer_flexible_calc(video_path):
    ...
    while l < r - 1:
        ...
        if len(tokenizer.encode(P['text'], bos=False, eos=False)) > 1000:
            l = mid
        else:
            r = mid
