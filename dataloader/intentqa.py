...
class IntentQA(BaseDataset):
    def __init__(self, args=None, tokenizer=None, split='train'):
        ...
        if args.use_cap:
            self.caption = json.load(open(f'./data/intentqa/llava_v15_{args.cap_model}_n6.json'))
        self.mm_features = {}
        self.mm_texts = {}
        ...
        if args.use_vis:
            ...
            self.mm_features['video'] = video_loader(f'./data/intentqa/clipvitl14.pth', self.max_feats['video'])
        if args.use_box:
            data = json.load(open(f'./data/intentqa/bbox/bbox_{args.box_format}.json'))
...
if __name__ == '__main__':
    ...
    dataset = IntentQA(args, tokenizer=tokenizer, split='train')
    L = []
    ...
    # vis: 107 for train and 102 for val and 106 for test.  Use 120
    # cap: 1014 for train and 1056 for val and 966 for test. Use 1100
    # box: 1092 for train and 1080 for val. Use 1100
    # cap + box: 1918 for train and 2020 for val. Use 2100