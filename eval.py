...
def get_args_parser():
    ...
    parser.add_argument('--pose_max_feats', type=int, default=1, metavar='LENGTH', help='the maximum pose keypoint feature length')
    parser.add_argument('--pose_input_dim', type=int, default=None, metavar='LENGTH', help='the vector length of pose')
    parser.add_argument('--box_max_feats', type=int, default=1, metavar='LENGTH', help='the maximum pose keypoint feature length')
    parser.add_argument('--box_input_dim', type=int, default=None, metavar='LENGTH', help='the vector length of pose')
    ...
    parser.add_argument('--vocab_path', type=str, default=None, help='path of the vocabulary embedding file')
    parser.add_argument('--subset', action='store_true', help='subset')
    parser.add_argument('--zero_init', action='store_true', help='zero init projectors')
    parser.add_argument('--dlr', action='store_true', help='dlr')
    parser.add_argument('--dlr_format', action='store_true', help='dlr')
    parser.add_argument('--efficiency', default=None, type=int)
    parser.add_argument('--dim_expand', default=1, type=int)
    # parser.add_argument('--pose_model', type=str, default=None, help='pose model')
    return parser
...
if __name__ == '__main__':
    ...
    if args.use_pose:
        args.mm_used.append('keypoints')
        args.max_feats['keypoints'] = args.pose_max_feats
        args.input_dims['keypoints'] = args.pose_input_dim
    if args.use_box:
